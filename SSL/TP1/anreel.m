...
% de 6 signaux r�els
% en choisissant leur cadence d'�chantillonnage
%

% nicole le 24/11/2014
%
% choix du signal � traiter
%
nom1='Cri sonar de chauve-souris ';
nom2='D�collage d''avion';
...
chsig=1;
while chsig<8
  chsig=menu('Choix de signaux',nom1,nom2,nom3,nom4,nom5,nom6,nom7,'FIN');
  if chsig==1
     load cs2.mat
     nom=nom1;
  end;
  ...
  if chsig<8
	...
	% calcul des spectres
		...
		set(gca,'XLim',[0 nu(length(nu))],'YLim',[-20 2])
