function [TF,t,nu]=sgram(x,nue,dB,fig);
% function [TF,t,nu]=sgram(x,nue,dB,fig);
%
...
%   - le numéro de la figure de destination
%
% les variables de sorties sont :
%   - TF : le spectrogramme en dB tronqué à -dB en dessous de son maximum
%   - t et nu : les variables temps et fréquences utilisées pour le tracé.
%
...
axes(axspec);
[Pxx,W] = pwelch(x,hanning(512),200,1024,nue);
